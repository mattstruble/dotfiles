...
- **pi** — Configuration and assets for the Pi coding agent, which runs as a subagent-based AI assistant with multiple agent roles including planner, orchestrator, builder, coder, and reviewers.
