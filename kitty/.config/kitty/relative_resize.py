"""Smart-splits.nvim kitten for kitty relative resize.

Called by smart-splits via `kitty @ kitten relative_resize.py <direction> <amount>`
for cross-boundary resize between neovim and kitty panes.

Based on: https://github.com/chancez/dotfiles
Source: https://github.com/mrjones2014/smart-splits.nvim/blob/master/kitty/relative_resize.py
"""
