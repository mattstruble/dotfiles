  ...
  programs.zen-browser = {
    ...
    profiles.default = {
      ...
      settings = {
        ...
        # --- Zen UI: collapsed sidebar, no compact auto-start, standard toolbar ---
        "zen.view.sidebar-expanded" = false;
        "zen.view.compact.enable-at-startup" = false;
        "zen.view.use-single-toolbar" = false;
        "widget.non-native-theme.use-theme-accent" = false;

        # --- Toolbar layout: pinned extensions and button arrangement (frozen) ---
        "browser.uiCustomization.state" =
          ''{"placements":{"widget-overflow-fixed-list":[],"unified-extensions-area":["private-relay_firefox_com-browser-action","trackmenot_mrl_nyu_edu-browser-action","plugin_okta_com-browser-action","addon_darkreader_org-browser-action","_74145f27-f039-47ce-a470-a662b129930a_-browser-action","sponsorblocker_ajay_app-browser-action","dearrow_ajay_app-browser-action","_d7742d87-e61d-4b78-b8a1-b469842139fa_-browser-action","_c2c003ee-bd69-42a2-b0e9-6f34222cb046_-browser-action","_contain-facebook-browser-action","_a3f8e50c-bc39-4e48-ae2f-2ed36fa6752b_-browser-action","skipredirect_sblask-browser-action","_f209234a-76f0-4735-9920-eb62507a54cd_-browser-action","_a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad_-browser-action","enhancerforyoutube_maximerf_addons_mozilla_org-browser-action","disable-twitch-extensions_rootonline_de-browser-action"],"nav-bar":["back-button","forward-button","stop-reload-button","customizableui-special-spring1","vertical-spacer","urlbar-container","customizableui-special-spring2","unified-extensions-button","jid1-hgpgb0x6133hig_jetpack-browser-action","ublock0_raymondhill_net-browser-action","adnauseam_rednoise_org-browser-action","_d634138d-c276-4fc8-924b-40a0ea21d284_-browser-action","addon_karakeep_app-browser-action","_174b2d58-b983-4501-ab4b-07e71203cb43_-browser-action","reset-pbm-toolbar-button"],"TabsToolbar":["tabbrowser-tabs"],"vertical-tabs":[],"PersonalToolbar":["import-button","personal-bookmarks"],"zen-sidebar-top-buttons":["zen-toggle-compact-mode"],"zen-sidebar-foot-buttons":["downloads-button","zen-workspaces-button","zen-create-new-button"]},"seen":["developer-button","screenshot-button","ublock0_raymondhill_net-browser-action","_d634138d-c276-4fc8-924b-40a0ea21d284_-browser-action","_c2c003ee-bd69-42a2-b0e9-6f34222cb046_-browser-action","_d7742d87-e61d-4b78-b8a1-b469842139fa_-browser-action","plugin_okta_com-browser-action","_74145f27-f039-47ce-a470-a662b129930a_-browser-action","_contain-facebook-browser-action","_a3f8e50c-bc39-4e48-ae2f-2ed36fa6752b_-browser-action","dearrow_ajay_app-browser-action","jid1-hgpgb0x6133hig_jetpack-browser-action","skipredirect_sblask-browser-action","_f209234a-76f0-4735-9920-eb62507a54cd_-browser-action","sponsorblocker_ajay_app-browser-action","_a4c4eda4-fb84-4a84-b4a1-f7c1cbf2a1ad_-browser-action","addon_karakeep_app-browser-action","enhancerforyoutube_maximerf_addons_mozilla_org-browser-action","_174b2d58-b983-4501-ab4b-07e71203cb43_-browser-action","adnauseam_rednoise_org-browser-action","trackmenot_mrl_nyu_edu-browser-action","addon_darkreader_org-browser-action","private-relay_firefox_com-browser-action","disable-twitch-extensions_rootonline_de-browser-action","reset-pbm-toolbar-button"],"dirtyAreaCache":["nav-bar","vertical-tabs","zen-sidebar-foot-buttons","PersonalToolbar","TabsToolbar","zen-sidebar-top-buttons","unified-extensions-area"],"currentVersion":24,"newElementCount":5}'';
      };
